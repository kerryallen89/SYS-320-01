...
cat /var/log/apache2/access.log.1 /var/log/apache2/access.log > /var/log/apache2/accessV2.log

# got this line from Gavin F's script, log.1 randomly stopped collecting relevant data once I started to do this lab.
# these two log files are so confusing man :(

logFile="/var/log/apache2/accessV2.log"
